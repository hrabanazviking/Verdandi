"""
Eir — Memory Consolidation Pipeline
======================================
...
This is the **consolidation pipeline** — distinct from the
heartbeat EirCheck (which monitors physical system health)
and EirAction (which auto-heals corrupted databases).

This module handles the *memory* healing:
